...
@:keep @:bind #if display private #end class __ASSET__assets_mapcsv_group1_zombies_csv extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_bg_sound_in_loop_maybe_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_decisions_mp3 extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_grenade_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_gun_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_shotgun_wav extends flash.media.Sound { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_sounds_go_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_what_you_want_ver_2_mp3 extends flash.media.Sound { }
