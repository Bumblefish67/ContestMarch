...
public class GameActivity extends Activity implements SensorEventListener {
	...
	public static int getResourceID (String inFilename) {
		...
		//if (inFilename.equals("assets/sounds/BG sound in loop maybe.mp3")) return com.example.myapp.R.raw.assets_sounds_bg_sound_in_loop_maybe_mp3;
		//if (inFilename.equals("assets/sounds/Decisions.mp3")) return com.example.myapp.R.raw.assets_sounds_decisions_mp3;
		//if (inFilename.equals("assets/sounds/What You Want ver 2.mp3")) return com.example.myapp.R.raw.assets_sounds_what_you_want_ver_2_mp3;
		//
		//if (inFilename.equals("assets/sounds/grenade.wav")) return com.example.myapp.R.raw.assets_sounds_grenade_wav;
		//if (inFilename.equals("assets/sounds/gun.wav")) return com.example.myapp.R.raw.assets_sounds_gun_wav;
		//if (inFilename.equals("assets/sounds/shotgun.wav")) return com.example.myapp.R.raw.assets_sounds_shotgun_wav;
